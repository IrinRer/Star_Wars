...
export const getSelectorCharacters = (state: RootState) =>
  state.data.selectedCharacter;
export const getLoading = (state: RootState) => state.data.loading;
export const getSearchCharacters = (state: RootState) =>
  state.data.searchCharacter;
...
export const getFormat = (state: RootState) => state.data.format;
